...
class CIFARDataModule(LightningDataModule):
    """Example of LightningDataModule for CIFAR dataset.
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        print("Length of CIFAR train: ", len(CIFAR10(self.hparams.data_dir, train=True)))
        print("Length of CIFAR test: ", len(CIFAR10(self.hparams.data_dir, train=False)))
